...
source ~/aliases.zsh
source ~/.gitalias.zsh
export FZF_DEFAULT_OPTS=$FZF_DEFAULT_OPTS' --color=fg:#8b949e,bg:#0d1117,hl:#ffffff --color=fg+:#c9d1d9,bg+:#111d2e,hl+:#fdac54 --color=info:#d29922,prompt:#58a6ff,pointer:#a371f7 --color=marker:#ec8e2c,spinner:#6e7681,header:#343941'
export GTK_THEME=Adwaita-dark

# bun completions
[ -s "/home/vaibhav/.bun/_bun" ] && source "/home/vaibhav/.bun/_bun"
